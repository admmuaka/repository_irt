...
Les items avec une faible discrimination (a \< 0.5) sont moins efficaces pour distinguer entre les individus avec différents niveaux du trait latent. Ces items incluent :
...
Q6, Q7, Q12, Q13, DPSY_A1, DPSY_A2, DPSY\_\_A5, DPSY_B2 ,DPSY_C4, DS_A1 ,DS_A2, DS_A5 ,DS_B2,DC_B3, DC_C5, DC_C6, DC_C8
...
Les items avec une haute difficulté (b \> 2) sont des items plus difficiles que seule une petite proportion de répondants est susceptible d'approuver, même à des niveaux plus élevés du trait latent. Ces items incluent :
